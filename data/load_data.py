...
from data.model.clip_model.simple_tokenizer import SimpleTokenizer
import os
import numpy as np
...
def generate_dataset(captionFile: str,
    ...
    # np.save('save_data\query_data_captions.npy', split_captions[0])
    # np.save('save_data\/retrieval_data_captions.npy', split_captions[2])
    # np.save('save_data\query_data_index.npy', split_indexs[0])
    # np.save('save_data\/retrieval_data_index.npy', split_indexs[2])
